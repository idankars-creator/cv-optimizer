...
export default async function RolesPage() {
  ...
  return (
    <GradientShell>
      <Sidebar />
      <main className="mx-auto max-w-6xl px-4 md:px-8 pt-8 md:pt-12 pb-24 md:pb-12 md:pl-20">
        <header className="space-y-2">
          <div className="text-[11px] uppercase tracking-[0.18em] text-white/55">
            Multi-role
          </div>
          <h1 className="font-serif italic text-3xl md:text-5xl text-white leading-tight">
            One CV per role you're chasing.
          </h1>
          <p className="text-white/70 md:text-lg">
            We tailor a fresh CV for each target role. The first is free —
            unlock the rest as you go.
          </p>
        </header>
