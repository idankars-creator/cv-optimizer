    ...
    <main className="min-h-screen bg-[#F8F7F4]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <header className="text-center max-w-2xl mx-auto">
          <p className="text-[12px] uppercase tracking-[0.18em] text-[#B8860B] font-semibold">Resume examples</p>
          <h1 className="mt-2 text-3xl sm:text-4xl font-bold text-[#0A2647]">
            Resume examples that actually get interviews
          </h1>
          <p className="mt-3 text-stone-600 leading-relaxed">
            Real-world resume examples by job title, written the way recruiters and ATS want to read them — quantified
            impact, strong verbs, clean structure. Pick one, then make it yours with AI in minutes.
          </p>
        </header>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {RESUME_EXAMPLES.map((ex) => (
            ...
            >
              ...
              <h2 className="mt-1 text-lg font-semibold text-[#0A2647]">{ex.role} resume example</h2>
